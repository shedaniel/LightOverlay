...
public class ClothScreen {
    public static Screen getConfigScreenByCloth(Screen parent) {
        ...
        general.addEntry(eb.startBooleanToggle(Component.translatable("config.lightoverlay.caching"), LightOverlay.caching).setDefaultValue(true).setSaveConsumer(bool -> LightOverlay.caching = bool).build());
