...
public class LOModMenuEntry implements ModMenuApi {
    ...
    public Screen getConfigScreenByCloth(Screen parent) {
        ...
        general.addEntry(eb.startIntSlider(new TranslatableText("config.lightoverlay.crossLevel2"), LightOverlay.crossLevel2, 0, 15).setDefaultValue(1).setTextGetter(integer -> new LiteralText("Secondary Level: " + integer)).setSaveConsumer(integer -> LightOverlay.crossLevel2 = integer).build());
